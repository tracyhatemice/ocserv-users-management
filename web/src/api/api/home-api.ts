...
export const HomeApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HomeGetHomeResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.homeGet(authorization, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['HomeApi.homeGet']?.[localVarOperationServerIndex]?.url;
...
export const HomeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        homeGet(
            ...
            options?: RawAxiosRequestConfig
        ): AxiosPromise<HomeGetHomeResponse> {
            return localVarFp
