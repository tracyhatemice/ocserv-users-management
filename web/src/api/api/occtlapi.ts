...
export const OCCTLApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async occtlCommandsGet(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.occtlCommandsGet(
                authorization,
                action,
                value,
                options
            ...
            const localVarOperationServerBasePath =
                operationServerMap['OCCTLApi.occtlCommandsGet']?.[localVarOperationServerIndex]?.url;
        ...
        async occtlServerInfoGet(
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModelsServerVersion>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.occtlServerInfoGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['OCCTLApi.occtlServerInfoGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
...
export class OCCTLApi extends BaseAPI {
    ...
    public occtlCommandsGet(requestParameters: OCCTLApiOcctlCommandsGetRequest, options?: RawAxiosRequestConfig) {
        return OCCTLApiFp(this.configuration)
            .occtlCommandsGet(requestParameters.authorization, requestParameters.action, requestParameters.value, options)
