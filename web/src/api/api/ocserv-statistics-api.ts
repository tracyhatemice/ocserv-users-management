...
export const OcservStatisticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        ocservUsersStatisticsGet: async (
...
export const OcservStatisticsApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ocservUsersStatisticsGet(
            authorization: string,
            dateStart: string,
            dateEnd: string,
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsDailyTraffic>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ocservUsersStatisticsGet(
                authorization,
                dateStart,
                dateEnd,
                options
            ...
            const localVarOperationServerBasePath =
                operationServerMap['OcservStatisticsApi.ocservUsersStatisticsGet']?.[localVarOperationServerIndex]?.url;
 ...
 * @export
 */
export const OcservStatisticsApiFactory = function (
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ocservUsersStatisticsGet(
            requestParameters: OcservStatisticsApiOcservUsersStatisticsGetRequest,
            options?: RawAxiosRequestConfig
...
export class OcservStatisticsApi extends BaseAPI {
     ...
     */
    public ocservUsersStatisticsGet(
        requestParameters: OcservStatisticsApiOcservUsersStatisticsGetRequest,
        options?: RawAxiosRequestConfig
    ) {
        return OcservStatisticsApiFp(this.configuration)
            .ocservUsersStatisticsGet(
                requestParameters.authorization,
                requestParameters.dateStart,
                requestParameters.dateEnd,
